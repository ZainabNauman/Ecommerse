...
import 'package:ecommerse/views/dashboard/home/addtoCart/addtocart.dart';
 ...
 @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        appBar: CustomAppBar(
        title: StringConstant.titleString,
        actions: [
        ...
        Padding(padding:  EdgeInsets.symmetric(horizontal: size.width*0.02),
            child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,children: [
              ...
              if(Responsive.isMobile(context)) Expanded(
                  child: Padding(padding: EdgeInsets.symmetric(vertical:size.width*0.03),
                    child: Container(
                      decoration: BoxDecoration(color: const Color.fromARGB(255, 226, 225, 225),borderRadius: BorderRadius.circular(15)),
              ...
              Expanded(child: FutureBuilder<List<ItemModel>>(
                future: fetchAll(userDataProvider.profileData.brand), 
