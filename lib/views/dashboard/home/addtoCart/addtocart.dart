...
class _AddtoCartState extends State<AddtoCart> {
  ...
  void initState() {
    ...
    //_fetchTotalQuantities(cartProvider.cartItems);
  }
...
//  Future<void> _fetchTotalQuantities(List<ItemModel> cartItems) async {
//   final cartProvider = Provider.of<AddtoCartProvider>(context, listen: false);
...
//       try {
//         cartProvider.updateItemQuantity(context, item, availableQuantity);
//       } catch (e) {
